...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 17 Haz 2021, 11:24:46
...
CREATE TABLE `ayar` (
  ...
  `ayar_skype` varchar(100) COLLATE utf8_turkish_ci NOT NULL,
  `ayar_linkedn` varchar(100) COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `ayar` (`ayar_id`, `ayar_logo`, `ayar_url`, `ayar_title`, `ayar_description`, `ayar_keywords`, `ayar_author`, `ayar_tel`, `ayar_gsm`, `ayar_faks`, `ayar_mail`, `ayar_ilce`, `ayar_il`, `ayar_adres`, `ayar_mesai`, `ayar_maps`, `ayar_analystic`, `ayar_zopim`, `ayar_facebook`, `ayar_twitter`, `ayar_instagram`, `ayar_skype`, `ayar_linkedn`, `ayar_google`, `ayar_youtube`, `ayar_smtphost`, `ayar_smtpuser`, `ayar_smtppassword`, `ayar_smtpport`, `ayar_bakim`) VALUES
(0, 'dimg/28502303592594530277s.jpg', '', 'Deniz Ayas', 'Deniz Ayas ', 'blog, php, özgeçmiş', 'Deniz Ayas', '', '', '', '', '', '', '', '10-20', 'ayar_maps_api0', 'ayar_analystic0', 'ayar_zopima0', '', '', 'https://www.instagram.com/denizayaas', '', '', '', '', 'mail.alanadiniz.com', 'mail@alanadiniz.com', 'smtppassword', '587', '1');
...
CREATE TABLE `hakkimda` (
  ...
  `hakkimda_unvan` varchar(100) COLLATE utf8_turkish_ci NOT NULL,
  `hakkimda_resim` varchar(250) COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `hakkimda` (`hakkimda_id`, `hakkimda_unvan`, `hakkimda_resim`, `hakkimda_icerik`) VALUES
(0, 'Frontend Developer', '', 'Deniz Ayas');
...
INSERT INTO `kullanici` (`kullanici_id`, `kullanici_resim`, `kullanici_tc`, `kullanici_ad`, `kullanici_mail`, `kullanici_tel`, `kullanici_password`, `kullanici_adsoyad`, `kullanici_adres`, `kullanici_il`, `kullanici_ilce`, `kullanici_unvan`, `kullanici_yetki`) VALUES
(1, '', '11122233344', 'Deniz Ayas', 'admin', '534 720 09 05', '827ccb0eea8a706c4c34a16891f84e7b', 'Deniz', '', 'İzmir', 'Bornova', 'Php Developer', '5');
...
--
ALTER TABLE `kullanici`
  MODIFY `kullanici_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=157;
COMMIT;
